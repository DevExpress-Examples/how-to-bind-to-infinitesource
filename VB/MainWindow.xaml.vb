...
Namespace InfiniteSourceSample
    Partial Public Class MainWindow
        ...
        Public Sub New()
            ...
            Dim source = New InfiniteSource() With {.ElementType = GetType(IssueData)}
        ...
        End Sub
        Private Shared Function FetchRows(ByVal e As FetchRowsEventArgs) As FetchRowsResult
        ...
        Private Shared Function GetIssueSortOrder(ByVal e As FetchRowsEventArgs) As IssueSortOrder
