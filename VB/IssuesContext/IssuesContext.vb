...
Namespace InfiniteSourceSample
    Public Class IssuesContext
        ...
        Public Function GetIssues(ByVal page As Integer, ByVal pageSize As Integer, ByVal sortOrder As IssueSortOrder, ByVal filter As IssueFilter) As IssueData()
            CheckAccess()
            Thread.Sleep(300)
        ...
        Public Function GetSummaries(ByVal filter As IssueFilter) As IssuesSummaries
            CheckAccess()
            Thread.Sleep(300)
        ...
        Private Sub CheckAccess()
            If workingThread IsNot Thread.CurrentThread Then
